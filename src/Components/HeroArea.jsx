...
function HeroArea() {
  return (
    <section className='relative overflow-hidden'>
        ...
        <div className="container pt-[297px] lg:pb-[241px] md:pb-[200px] pb-[180px] mx-auto flex items-center justify-center flex-col lg:px-1 px-5 relative"> 
            <div className=' relative flex items-center justify-center flex-col z-15'>
