...
function PricingPlans() {
  return (
    <section className='lg:mt-30 md:mt-20 mt-15 max-w-[1468px] mx-auto'>
        <div className='flex justify-between items-center 2xl:gap-30 xl:gap-23 gap-10 xl:flex-row flex-col'>
            <div className="flex-1/3 flex flex-col items-center justify-center px-5 md:px-8 lg:px-4 xl:px-0">
                <div>
                    ...
                    <h2 className='text-5xl font-bold leading-[60px] font-robote mt-2 max-w-[348px]'>Our Twitter Pricing Plans.</h2>
                    <p className='my-6 font-medium text-[20px] leading-[70px] font-epilogue'>Save 30% on the yearly Packages</p>
                    <div className="font-epilogue uppercase font-normal text-base flex justify-start gap-2 items-center">
                        MONTHLY
